...
| **Journal**   | Session log files recording what was done in each development session                                             | `.trellis/workspace/journal-N.md` |
...
| **Team Sync**                 | Share specs across your project. One person's best practice benefits everyone               |
