...
can read when you want the same `.trellis/spec/` starting point across many
repositories.
...
Treat template ids as public API for your project. If you need a breaking rewrite,
